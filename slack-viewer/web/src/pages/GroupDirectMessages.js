...
const GroupDirectMessagesContent = lazy(() => import("../features/GroupDirectMessages/GroupDirectMessagesContent")) ;
    ...
    return (
        ...
        >
            <Suspense fallback={<Spinner/>}>
                <GroupDirectMessagesContent/>
            </Suspense>
        </ErrorBoundary>
    );
};

export default GroupDirectMessages;
